// Command handler is a Lambda function for the emulator tests. It writes one
// line of every shape the extension is expected to recognize, so the tests can
// assert on what the extension made of them.
//
...
const otlpTraces = `{"resourceSpans":[{"resource":{"attributes":[{"key":"service.name","value":{"stringValue":"rie-func"}}]},"scopeSpans":[{"scope":{"name":"rie-instrumentation","version":"1.2.3"},"spans":[{"traceId":"5b8efff798038103d269b633813fc60c","spanId":"eee19b7ec3c1b174","name":"handler","kind":2,"startTimeUnixNano":"1753000000000000000","endTimeUnixNano":"1753000000123000000","attributes":[{"key":"http.status_code","value":{"intValue":"200"}}]}]}]}]}`

// otlpLogs is the log-signal equivalent.
const otlpLogs = `{"resourceLogs":[{"resource":{"attributes":[{"key":"service.name","value":{"stringValue":"rie-func"}}]},"scopeLogs":[{"logRecords":[{"timeUnixNano":"1753000000000000000","severityText":"ERROR","body":{"stringValue":"captured log record"}}]}]}]}`
